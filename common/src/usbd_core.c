...
usbd_status_t usbd_init(USBD_HandleTypeDef *pdev, USBD_DescriptorsTypeDef *pdesc, uint8_t id) {
...
usbd_status_t usbd_register_class(USBD_HandleTypeDef *pdev, USBD_ClassTypeDef *pclass) {
    uint16_t len = 0U;
...
usbd_status_t usbd_ll_setup_stage(USBD_HandleTypeDef *pdev, uint8_t *psetup) {
    usbd_status_t ret;
...
usbd_status_t usbd_ll_data_out_stage(USBD_HandleTypeDef *pdev, uint8_t epnum, uint8_t *pdata) {
